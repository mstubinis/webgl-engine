...
(function(Vecmath) {
  ...
  Vecmath.Mat3.prototype.cofac = function(r1,c1,r2,c2){
    return (this.getElement(r1,c1) * this.getElement(r2,c2)) - (this.getElement(r1,c2) * this.getElement(r2,c1));
  }
  Vecmath.Mat3.prototype.inverse=function() {
    var co = new Vecmath.Vec3(this.cofac(1, 1, 2, 2),this.cofac(1, 2, 2, 0),this.cofac(1, 0, 2, 1));
    var row = new Vecmath.Vec3(); this.getRow(0,row);
    var det = row.dot(co);
    var s = 1.0 / det;
    var res = new Vecmath.Mat3();
    res.set9(co.x * s,this.cofac(0, 2, 2, 1) * s,this.cofac(0, 1, 1, 2) * s,
...
(function(Bullet) {
  ...
  Bullet.RigidBody.prototype.applyTorque = function(t){
      this.totalTorque.x += t.x*this.angularFactor;
      this.totalTorque.y += t.y*this.angularFactor;
      this.totalTorque.z += t.z*this.angularFactor;
  }
